...
const config = {
  ...
  organizationName: 'zenon-network', // Usually your GitHub org/user name.
  projectName: 'zenon-info.github.io', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/zenon-info/zenon-info.github.io/tree/main/',
        },
        blog: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/zenon-info',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Zenon.info, Built with Docusaurus.`,
      },
      prism: {
